...
describe('ReadPropertyAcknowledge', () => {
	...
	it('should successfully encode and decode an real value', () => {
		...
		expect(Math.floor(0.1 * 10000)).toEqual(
			Math.floor(result.values[1].value * 10000),
		)
			...
			[
				{
					type: 7,
					value: '',
					encoding: baEnum.CharacterStringEncoding.ISO_8859_1,
				},
				{
					type: 7,
					value: 'Test1234$äöü',
			...
			[
				{
					type: 7,
					value: '',
					encoding: baEnum.CharacterStringEncoding.UCS_2,
				},
				{
					type: 7,
					value: 'Test1234$äöü',
			...
			[
				{
					type: 7,
					value: '',
					encoding: baEnum.CharacterStringEncoding.MICROSOFT_DBCS,
				},
				{
					type: 7,
					value: 'Test1234$äöü',
			...
			[
				{
					type: 7,
					value: '',
					encoding: baEnum.CharacterStringEncoding.JIS_X_0208,
				},
				{
					type: 7,
					value: 'できます',
		...
		baServices.readProperty.encodeAcknowledge(
			...
			[
				...
				},
				{
					type: 115,
					value: {
						objectId: { type: 3, instance: 50000 },
						properties: [{ id: 85 }, { id: 1, index: 2 }],
					},
				},
			],
		)
